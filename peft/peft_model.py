...
PEFT_TYPE_TO_MODEL_MAPPING = {
    ...
    PeftType.EIGENFLUX: EigenFluxModel,
}
...
class PeftModel(PushToHubMixin, torch.nn.Module):
    ...
    **Attributes**:
    ...
    def save_pretrained(
        ...
        save_eigenflux_loadings: bool = True,
        save_eigenflux_components: bool = False,
        **kwargs: Any,
    ) -> None:
        r"""
        ...
        for adapter_name in selected_adapters:
            ...
            output_state_dict = get_peft_model_state_dict(
                ...
                save_eigenflux_loadings=save_eigenflux_loadings,
                save_eigenflux_components=save_eigenflux_components,
            )
            output_dir = (
